...
var VaultItem = new keystone.List('VaultItem', {
...
VaultItem.schema.virtual('canAccessKeystone').get(function () {
  return true;
});

VaultItem.schema.pre('save', function (next) {
  let event = this;
...
VaultItem.defaultColumns = 'title, description';
